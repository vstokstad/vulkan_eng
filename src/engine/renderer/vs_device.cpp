...
void vs_device::createCommandPool() {
...
void vs_device::setupDebugMessenger() {
  if (!enableValidationLayers)
    return;
  VkDebugUtilsMessengerCreateInfoEXT createInfo;
...
bool vs_device::checkValidationLayerSupport() {
  uint32_t layerCount;
...
std::vector<const char *> vs_device::getRequiredExtensions() {
...
void vs_device::hasGflwRequiredInstanceExtensions() {
...
bool vs_device::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices vs_device::findQueueFamilies(VkPhysicalDevice device) {
...
vs_device::querySwapChainSupport(VkPhysicalDevice device) {
...
VkFormat vs_device::findSupportedFormat(const std::vector<VkFormat> &candidates,
...
uint32_t vs_device::findMemoryType(uint32_t typeFilter,
...
void vs_device::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage,
...
VkCommandBuffer vs_device::beginSingleTimeCommands() {
...
void vs_device::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void vs_device::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer,
                           VkDeviceSize size) {
...
void vs_device::copyBufferToImage(VkBuffer buffer, VkImage image,
...
void vs_device::createImageWithInfo(const VkImageCreateInfo &imageInfo,
                                    VkMemoryPropertyFlags properties,
                                    VkImage &image,
