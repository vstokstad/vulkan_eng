...
void vs_point_light_render_system::createPipelineLayout(
    VkDescriptorSetLayout global_set_layout) {
...
void vs_point_light_render_system::createPipeline(VkRenderPass render_pass) {
...
void vs_point_light_render_system::render(frame_info &frame_info) {
  ...
  for (auto &kv : frame_info.lights) {
    ...
    vkCmdPushConstants(frame_info.command_buffer, pipeline_layout_,
                       ...
                       0, sizeof(point_light_push_constants), &push);
