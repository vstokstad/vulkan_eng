...
namespace vs
{
	...
	vs_simple_render_system::vs_simple_render_system(vs_device& device, VkRenderPass render_pass,
	...
	void vs_simple_render_system::createPipelineLayout(VkDescriptorSetLayout global_set_layout)
	{
	...
	void vs_simple_render_system::renderGameObjects(frame_info& frame_info)
	{
		...
		for (auto& [key, object]: frame_info.game_objects)
		{

			//if (object.model_comp == nullptr)continue;
