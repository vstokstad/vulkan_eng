...
namespace vs {
void vs_camera::setOrthographicProjection(float left, float right, float top,
...
void vs_camera::setPerspectiveProjection(float fovy, float aspect, float near,
                                         float far) {
...
void vs_camera::setViewDirection(glm::vec3 position, glm::vec3 direction,
                                 glm::vec3 up) {
...
void vs_camera::setViewTarget(glm::vec3 position, glm::vec3 target,
                              glm::vec3 up) {
